...
<head>
  ...
  <title>Lunare Clothing — Careers</title>
  ...
  <section class="careers-page">
    <div class="container">
      <div class="careers-header">
        <h1>Careers at Lunare</h1>
        <p class="subtitle">Join our team and help shape the future of fashion</p>
      </div>

      <div class="careers-section">
        <h2>Why Work With Us?</h2>
        <p>
          At Lunare Clothing, we are building more than a fashion brand. We are creating a team of
          ambitious people who want to innovate, grow, and make an impact in a fast-moving industry.
        </p>
        <p>
          Whether your passion is design, marketing, technology, customer service, or operations,
          Lunare offers the chance to be part of something exciting and forward-thinking.
        </p>
      </div>
      ...
      <div class="careers-grid">
        <div class="careers-card">
          ...
          <p>Work with a team that values fresh ideas, innovation, and individuality.</p>
        </div>

        <div class="careers-card">
          <h3>Growth Opportunities</h3>
          <p>We support personal development and encourage our team to build new skills.</p>
        </div>

        <div class="careers-card">
          <h3>Passionate Team</h3>
          <p>Be part of a brand driven by creativity, energy, and ambition.</p>
        </div>
      </div>
      ...
      <div class="careers-section">
        ...
        <div class="job-listings">
          <div class="job-card">
            ...
            <p>Support customers, maintain store standards, and represent the Lunare brand.</p>
          </div>

          <div class="job-card">
            <h3>Marketing Assistant</h3>
            <p><strong>Location:</strong> Hybrid</p>
            <p>Help manage campaigns, social media, and digital content for Lunare Clothing.</p>
          </div>

          <div class="job-card">
            <h3>Web Developer</h3>
            <p><strong>Location:</strong> Remote / Hybrid</p>
            <p>Work on improving our online store, user experience, and digital features.</p>
          </div>
        </div>
      </div>
      ...
      <div class="careers-section">
        <h2>Apply With Us</h2>
        <p>
          Interested in joining Lunare? Send your CV and a short introduction through our
          contact page, and our team will be in touch when suitable opportunities are available.
        </p>
