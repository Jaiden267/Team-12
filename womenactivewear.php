...
$result = $conn->query("SELECT products.*, image_url FROM products LEFT JOIN product_images ON products.product_id = product_images.product_id WHERE category_id = 8 AND (product_images.is_main = 1 OR product_images.is_main IS NULL) $order_query");
...
<head>
  ...
  <title>Lunare Clothing — Women Activewear</title>
...
<body>
 ...
 <header class="site-header">
  ...
  <div class="page-header">
    <div class="container" style="display:flex; justify-content:space-between; align-items:center;">
      <h1>Womens — Activewear</h1>
      <form method="GET" action="womenactivewear.php" id="sortForm">
