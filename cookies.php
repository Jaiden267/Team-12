...
<head>
  ...
  <title>Lunare Clothing — Cookies Policy</title>
  ...
  <section class="cookies-page">
    <div class="container">
      <div class="cookies-header">
        ...
        <p class="subtitle">How Lunare Clothing uses cookies on our website</p>
      </div>
      ...
      <div class="cookies-section">
        ...
        <p>
          ...
          and actions, to improve your browsing experience.
        </p>
      </div>
      ...
      <div class="cookies-section">
        ...
        <p>
          Lunare Clothing uses cookies to keep the website running smoothly, remember user
          preferences, improve performance, and support features such as your basket and favourites.
        </p>
      </div>
      ...
      <div class="cookies-grid">
        <div class="cookies-card">
          ...
          <p>These cookies are necessary for the website to function properly, such as login sessions and basket features.</p>
        </div>

        <div class="cookies-card">
          <h3>Performance Cookies</h3>
          <p>These help us understand how visitors use our website so we can improve design and performance.</p>
        </div>

        <div class="cookies-card">
          <h3>Preference Cookies</h3>
          <p>These remember your settings and choices to provide a more personalised experience.</p>
        </div>
      </div>
      ...
      <div class="cookies-section">
        ...
        <p>
          In some cases, trusted third-party services may place cookies on our site for analytics,
          payment processing, or delivery support. These cookies are managed by the relevant providers.
        </p>
      </div>
      ...
      <div class="cookies-section">
        ...
        <p>
          We may update this Cookies Policy from time to time. Any changes will be shown on this page.
        </p>
      </div>
