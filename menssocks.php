...
$result = $conn->query("SELECT products.*, image_url FROM products LEFT JOIN product_images ON products.product_id = product_images.product_id WHERE category_id = 6 AND (product_images.is_main = 1 OR product_images.is_main IS NULL) $order_query");
...
<head>
  ...
  <title>Lunare Clothing — Men's Socks</title>
...
<body>
 ...
 <header class="site-header">
  ...
  <div class="page-header">
    <div class="container" style="display:flex; justify-content:space-between; align-items:center;">
      <h1>Mens — Socks</h1>
      <form method="GET" action="menssocks.php" id="sortForm">
