  ...
  <div class="container header-inner">
    ...
    <div class="actions">
      <button id="searchToggle" class="icon-btn">
        <svg viewBox="0 0 24 24"><circle cx="11" cy="11" r="7" stroke="currentColor"/><line x1="16.65" y1="16.65" x2="21" y2="21" stroke="currentColor"/></svg>
      </button>

      <button class="icon-btn">
        <svg viewBox="0 0 24 24"><path d="M12 21s-7-4.5-9-8.5S5 2 8.5 5.5L12 9l3.5-3.5C19 2 25 7 21 12.5S12 21 12 21z" stroke="currentColor"/></svg>
      </button>

      <button id="cartButton" class="icon-btn">
        <svg viewBox="0 0 24 24"><path d="M6 7h12l-1 13H7L6 7z" stroke="currentColor"/><path d="M9 7V5a3 3 0 1 1 6 0v2" stroke="currentColor"/></svg>
      </button>
  ...
  <main class="cart-wrap">
    <div class="container cart-grid">
      ...
      <section class="card">
        ...
        <h3 class="checkout-heading">Payment Details</h3>
      ...
      <aside class="card cart-summary">
        ...
        <button type="submit" class="btn primary" style="width:100%; margin-top:14px;">Pay Now</button>
      </aside>
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  form.addEventListener("submit", function (e) {
    ...
    const email = form.billing_email.value.trim();
    const cardNum = form.card_number.value.replace(/\D/g, "");
    ...
    if (!(parts.length === 2 && month >= 1 && month <= 12)) {
      errors.push("Enter expiry as MM/YY.");
    } else {
      const now = new Date();
      const currentYear = parseInt(String(now.getFullYear()).slice(2));
